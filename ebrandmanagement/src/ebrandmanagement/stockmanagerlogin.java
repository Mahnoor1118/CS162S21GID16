 ...
 * @author MAHNOOR SHAD
 */
public class stockmanagerlogin extends javax.swing.JFrame {

    /**
     * Creates new form stockmanagerlogin
     */
    public stockmanagerlogin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stockmanagerlogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new stockmanagerlogin().setVisible(true);
            }
        });
    }
